...
export const sampleValues: Record<DocumentType, Record<string, string>> = {
  "change-order": {
    ...
    date: "2026-06-28",
    impact: "Timeline extends by 5 business days. Additional fee is due with the next milestone invoice.",
    originalAgreement: "Website Build Agreement dated 2026-06-01",
    recipientSignature: "Amelia Grant",
    senderSignature: "Vish Seen",
  ...
  "contract-addendum": {
    ...
    unchangedTerms: "All confidentiality, ownership, limitation of liability, and termination terms remain unchanged.",
    updatedTerms:
  ...
  "formal-business-letter": {
    ...defaultPartyValues,
    body:
      "We are writing to confirm renewal of the service arrangement for the upcoming quarter. The attached schedule outlines support hours, reporting cadence, and the updated point of contact.",
    closing: "Sincerely, Vish Seen",
    date: "2026-06-20",
    salutation: "Dear Amelia,",
    senderSignature: "Vish Seen, Managing Director",
  ...
  "meeting-minutes-action-brief": {
    ...
    agenda: "Review launch status, approve content changes, and assign final owners.",
    attendees: "Amelia Grant, Vish Seen, Maya Patel, Jonas Reed, Priya Shah",
    decisions: "Launch remains targeted for July 1. The team approved the revised onboarding flow.",
    facilitator: "Vish Seen",
  ...
  "project-status-report": {
    ...
    risks: "Firebase production keys and billing plan copy still require final stakeholder confirmation.",
    status: "On track",
  ...
  contract: {
    ...
    paymentTerms: "50% due on signing, 50% on delivery. Invoices are payable within 14 days.",
    recipientSignature: "Amelia Grant",
    scope:
  ...
  invoice: {
    ...
    paymentInstructions: "Bank transfer to Dokiments Studio. Include invoice number as reference.",
    subtotal: "$2,550",
    tax: "$255",
  ...
  quotation: {
    ...defaultPartyValues,
    assumptions: "Pricing excludes paid media spend, third-party subscriptions, and rush delivery.",
    date: "2026-06-20",
  ...
  receipt: {
    ...
    notes: "Payment received in full. No outstanding balance remains for this invoice.",
